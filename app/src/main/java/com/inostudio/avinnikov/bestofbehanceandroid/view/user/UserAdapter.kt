...
internal class UserAdapter(private var projects: MutableList<Project>) : android.support.v7.widget.RecyclerView.Adapter<UserAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            Navigation.findNavController(holder.itemView.context as AppCompatActivity, R.id.my_nav_host_fragment)
                    .navigate(R.id.action_userFragment_to_projectViewFragment, bundle)
        }
